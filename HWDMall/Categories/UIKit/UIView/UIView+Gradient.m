...
#pragma mark - 渐变色由上到下(#EE8B0B -> #ED4D4D)
- (void)gradientLayerTopToBottom {
    
    CAGradientLayer *gl = [CAGradientLayer layer];
    gl.frame = self.bounds;
    gl.startPoint = CGPointMake(0, 0);
    gl.endPoint = CGPointMake(0, 1);
    gl.colors = @[(__bridge id)[UIColor hexColor:@"#EE8B0B"].CGColor,(__bridge id)[UIColor hexColor:@"#ED4D4D"].CGColor];
