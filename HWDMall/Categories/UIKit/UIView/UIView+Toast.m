...
static const NSString * SKBgViewKey  = @"SKBgViewKey";
...
- (void)makeToastActivity:(id)position {
    ...
    objc_setAssociatedObject (self, &SKBgViewKey, bgV, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
- (void)hideToastActivity {
    UIView *existingActivityView = (UIView *)objc_getAssociatedObject(self, &CSToastActivityViewKey);
    UIView *bgv = (UIView *)objc_getAssociatedObject(self, &SKBgViewKey);
