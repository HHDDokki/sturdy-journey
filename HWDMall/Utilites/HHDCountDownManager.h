...
/** 宏: 使用单例 */
#define kHHDCountDownManager [HHDCountDownManager manager]
/** 倒计时的通知名 */
extern NSString *const HHDCountDownNotification;

@interface HHDCountDownManager : NSObject
...
@interface HHDTimeInterval : NSObject
