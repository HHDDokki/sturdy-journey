...
- (void)setupDefault
{
    ...
    UILabel *lefL = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth/3, 40)];
    lefL.text = @"选择省份";
    lefL = [self setLable:lefL];
    [aaa addSubview:lefL];
    UILabel *zhongL = [[UILabel alloc]initWithFrame:CGRectMake(kScreenWidth/3 , 0, kScreenWidth/3, 40)];
    zhongL.text = @"选择城市";
    zhongL = [self setLable:zhongL];
    [aaa addSubview:zhongL];
    UILabel *rigL = [[UILabel alloc]initWithFrame:CGRectMake(kScreenWidth/3*2, 0, kScreenWidth/3, 40)];
    rigL.text = @"选择地区";
    rigL = [self setLable:rigL];
    [aaa addSubview:rigL];
    
    
    
}
-(UILabel *)setLable :(UILabel *)lab{
...
- (void)selectedOk
{
    self.getAddreeBlock(self.title);
    [self remove];
}
...
- (UIButton *)buttonLeft
{
    if (!_buttonLeft) {
        ...
        [_buttonLeft setTitleColor:[UIColor colorWithHexString:@"#999999"] forState:UIControlStateNormal];
//        [_buttonLeft addBorderColor:self.borderButtonColor];
        [_buttonLeft.titleLabel setFont:[UIFont systemFontOfSize:13]];
...
- (UIButton *)buttonRight
{
    if (!_buttonRight) {
        ...
        [_buttonRight setTitleColor:[UIColor colorWithHexString:@"#ED5E3B"] forState:UIControlStateNormal];
//        [_buttonRight addBorderColor:self.borderButtonColor];
        [_buttonRight.titleLabel setFont:[UIFont systemFontOfSize:13]];
