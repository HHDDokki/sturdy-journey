...
- (instancetype)initWithViewControllers:(NSArray *)viewControllers frame:(CGRect)frame options:(NSDictionary *)options currentPageIndex:(NSInteger)index;
{
...
- (void)setUpUserInterface
{
    ...
    _controllerScrollView.delaysContentTouches = YES;
    _controllerScrollView.canCancelContentTouches = YES;
    _controllerScrollView.panGestureRecognizer.delaysTouchesBegan = YES;
